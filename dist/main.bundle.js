...
var AddBooksComponent = (function () {
    function AddBooksComponent(authService, bookService, helperService, gBooksApiService, router, notify, pBarService) {
    ...
    AddBooksComponent.prototype.searchBooksAPI = function (form) {
        ...
        this.gBooksApiService
            ...
            .then(function (data) {
            _this.bookData = _this.helperService.convertToHttps(data);
    ...
    AddBooksComponent.prototype.addBook = function () {
        ...
        this.bookService
            ...
            if (err.status === 409) {
                _this.notify.error(_this.selectedBook.title, 'This book already exists in your collection');
            }
            _this.modalProgressBar = false;
        });
    };
...
var ProfileComponent = (function () {
    ...
    ProfileComponent.prototype.confirmDelete = function (book) {
        this.selectedBook = book;
        this.openModal();
    };
...
var HelperService = (function () {
    ...
    HelperService.prototype.convertToHttps = function (books) {
        var result = books.map(function (book) {
            var thumbnail = book.imageLinks.thumbnail.replace('http:', 'https:');
